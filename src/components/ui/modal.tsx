    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={cn(
            "animate-scale-in fixed inset-0 z-40 m-auto max-h-fit w-full max-w-md overflow-hidden border border-gray-200 dark:border-gray-800 dark:bg-zinc-950 bg-white p-0 shadow-xl sm:rounded-2xl",
            className
          )}
        >
          {children}
